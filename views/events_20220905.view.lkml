view: events_20220905 {
  sql_table_name: `analytics_265527797.events_20220905`
    ;;
...
view: events_20220905__items {
  ...
  dimension: events_20220905__items {
    type: string
    hidden: yes
    sql: events_20220905__items ;;
  }
...
view: events_20220905__event_params {
  dimension: events_20220905__event_params {
    type: string
    hidden: yes
    sql: events_20220905__event_params ;;
  }
...
view: events_20220905__user_properties {
  dimension: events_20220905__user_properties {
    type: string
    hidden: yes
    sql: events_20220905__user_properties ;;
  }
