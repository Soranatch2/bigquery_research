view: events_intraday_20220906 {
  sql_table_name: `analytics_265527797.events_intraday_20220906`
    ;;
...
view: events_intraday_20220906__items {
  ...
  dimension: events_intraday_20220906__items {
    type: string
    hidden: yes
    sql: events_intraday_20220906__items ;;
  }
...
view: events_intraday_20220906__event_params {
  dimension: events_intraday_20220906__event_params {
    type: string
    hidden: yes
    sql: events_intraday_20220906__event_params ;;
  }
...
view: events_intraday_20220906__user_properties {
  dimension: events_intraday_20220906__user_properties {
    type: string
    hidden: yes
    sql: events_intraday_20220906__user_properties ;;
  }
